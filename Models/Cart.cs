...
namespace FastFood.Models
{
    public class Cart
    {
        protected static readonly FoodDbContext db = new FoodDbContext();
        //------        
        ...
        //add item to cart
        public static void CartAdd(ISession session, int id, int quantity)
        {
            if (Cart.GetObjectFromJson<List<Item>>(session, "cart") == null)
            {
                ...
                cart.Add(new Item { ProductRecord = item, Quantity = quantity });
